...
public record ModuleCatalogRequest(string Name, string Slug, string BaseUrl, string Status, string? Icon);
public record ModuleCatalogResponse(Guid Id, string Name, string Slug, string BaseUrl, string? Icon, string Status, DateTime CreatedAt);
...
public record ModuleAssignmentResponse(Guid ModuleId, string Name, string Slug, string BaseUrl, string Status, bool Enabled, DateTime? ActivatedAt, string? Notes);
...
public record WorkspaceAppResponse(Guid ModuleId, string Name, string Slug, string BaseUrl, string Status, bool Enabled);
